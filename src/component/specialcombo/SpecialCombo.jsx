...
const SpecialCombo = () => {
  ...
  return (
    <div className="SpecialCombo">
      <div className="banner-right">
        <div className="banner-right-head">
          <h2 className="banner-right-para">SPECIAL COMBO OFFERS</h2>
          <p className="line"></p>
        </div>
          ...
          >
            <SwiperSlide className="Swiper-Slide">
              <img
                ...
                src="https://www.primeabgb.com/wp-content/uploads/2023/03/7900X-Plus-ProArt-X670E-CREATOR-WIFI.jpg"
                alt=""
              />
            ...
            <SwiperSlide className="Swiper-Slide">
              <img
                className="Swiper-Slide-img"
                src="https://www.primeabgb.com/wp-content/uploads/2023/03/7600X-Plus-PRIME-X670-P.jpg"
                alt=""
              />
              <p className="Swiper-Slide-para">
            ...
            <SwiperSlide className="Swiper-Slide">
              <img
                className="Swiper-Slide-img"
                src="https://www.primeabgb.com/wp-content/uploads/2023/03/7700X-Plus-ROG-STRIX-B650E-F-Gaming-WiFi.jpg"
                alt=""
              />
              <p className="Swiper-Slide-para">
            ...
            <SwiperSlide className="Swiper-Slide">
              <img
                className="Swiper-Slide-img"
                src="https://www.primeabgb.com/wp-content/uploads/2023/03/7700X-Plus-PRIME-X670-P.jpg"
                alt=""
              />
              <p className="Swiper-Slide-para">
            ...
            <SwiperSlide className="Swiper-Slide">
              <img
                className="Swiper-Slide-img"
                src="https://www.primeabgb.com/wp-content/uploads/2023/03/ASUS-PRIME-Z790-P-CSM-Motherboard-with-Intel-Core-i9-12900K-12th-Gen-Processor.jpg"
                alt=""
              />
              <p className="Swiper-Slide-para">
            ...
            <SwiperSlide className="Swiper-Slide">
              <img
                className="Swiper-Slide-img"
                src="https://www.primeabgb.com/wp-content/uploads/2023/03/7900X-Plus-TUF-GAMING-B650-PLUS.jpg"
                alt=""
              />
              <p className="Swiper-Slide-para">
